...
const ProfileDrawer = ({ onClose, isOpen, data }: ProfileDrawerProps) => {
  ...
  return (
    <>
      <ConfirmModal isOpen={confirmOpen} onClose={onConfirmClose} />
                        ...
                        <div className='flex items-start justify-end'>
                          <div className='ml-3 flex h-7 items-center'>
                            <button
                              onClick={onClose}
                              type='button'
                              className='e-none rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2'
                            >
